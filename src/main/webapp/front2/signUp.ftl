                    ...
                    <div class="wrapper">
                        <div class="grid_16 suffix_1 prefix_1 alpha" style="padding-top: 12px">
                            ...
                            <form method="post" class="form">
                                ...
                                <p><input type="email" name="email" placeholder="Электронная почта" class="feedback_input"></p>
                                <p><input name="phoneNumber" placeholder="Мобильный телефон" class="feedback_input"></p>
                                <p><input type="password" name="hashPassword" placeholder="Пароль" class="feedback_input"></p>
